    ...
    shows: [
      {
        ...
        ticketUrl: 'https://calgary.broadway.com',
      ...
      },
      {
        ...
        ticketUrl: 'https://www.showpass.com',
    ...
    hotels: [
      {
        ...
        bookingUrl: 'https://www.booking.com/hotel/ca/the-dorian.html',
    ...
    experiences: [
      {
        ...
        bookingUrl: 'https://www.getyourguide.com/calgary-l1507/banff-national-park-day-trip',
    ...
    experiences: [
      {
        ...
        reviewCount: 950,
        priceFrom: '$89 / person',
        bookingUrl: 'https://www.viator.com/tours/Toronto/Kensington-Market-Food-Tour/d623-68212P2',
    ...
    restaurants: [
      {
        ...
        bookingPlatform: 'OpenTable',
        reservationUrl: 'https://www.opentable.com/miku-restaurant-vancouver',
      ...
      },
      {
        ...
        bookingPlatform: 'OpenTable',
        reservationUrl: 'https://www.opentable.com/r/botanist-vancouver',
    ...
    shows: [
      {
        ...
        ticketUrl: 'https://www.cirquedusoleil.com/echo',
        ticketPlatform: 'Box Office',
        availabilityStatus: 'Good Seats Available',
        badgeColor: 'emerald',
      },
    ...
    experiences: [
      {
        ...
        bookingUrl: 'https://www.viator.com/tours/Vancouver/Seaplane-Tour/d616-28212P1',
        bookingPlatform: 'Viator',
    ...
    hotels: [
      {
        ...
        bookingUrl: 'https://www.booking.com/hotel/ca/william-gray.html',
        bookingPlatform: 'Booking.com',
    ...
    experiences: [
      {
        ...
        reviewCount: 780,
        priceFrom: '$85 / person',
        bookingUrl: 'https://www.viator.com/tours/Montreal/Old-Montreal-Walking-Tour/d625-38212P1',
        bookingPlatform: 'Viator',
    ...
    shows: [
      {
        ...
        ticketUrl: 'https://edmonton.broadway.com',
        ticketPlatform: 'Box Office',
        availabilityStatus: 'Good Seats Available',
        badgeColor: 'emerald',
      },
    ...
    experiences: [
      {
        ...
        bookingUrl: 'https://www.getyourguide.com/edmonton-l1508/elk-island-bison-tour',
        bookingPlatform: 'GetYourGuide',
    ...
    experiences: [
      {
        ...
        reviewCount: 890,
        priceFrom: '$42 / person',
        bookingUrl: 'https://www.viator.com/tours/Ottawa/Rideau-Canal-Cruise/d628-88212P1',
        bookingPlatform: 'Viator',
    ...
    experiences: [
      {
        ...
        reviewCount: 920,
        priceFrom: '$22 / person',
        bookingUrl: 'https://humanrights.ca',
        bookingPlatform: 'Direct',
    ...
    experiences: [
      {
        ...
        reviewCount: 2200,
        priceFrom: '$59 / person',
        bookingUrl: 'https://www.viator.com/tours/Halifax/Peggys-Cove-Tour/d629-38212P1',
        bookingPlatform: 'Viator',
  ...
  yyj: {
    ...
    shows: [
      ...
      },
      {
        ...
        ticketUrl: 'https://pacificopera.ca',
        ticketPlatform: 'Box Office',
        availabilityStatus: 'Good Seats Available',
        badgeColor: 'emerald',
      },
    ...
    experiences: [
      {
        ...
        reviewCount: 3100,
        priceFrom: '$75 / person',
        bookingUrl: 'https://www.viator.com/tours/Victoria/Butchart-Gardens-Tour/d617-18212P1',
        bookingPlatform: 'Viator',
    ...
    hotels: [
      {
        ...
        bookingUrl: 'https://www.booking.com/hotel/ca/jag.html',
        bookingPlatform: 'Booking.com',
    ...
    experiences: [
      {
        ...
        reviewCount: 1800,
        priceFrom: '$85 / person',
        bookingUrl: 'https://www.viator.com/tours/St-Johns/Puffin-and-Whale-Watch/d630-28212P1',
        bookingPlatform: 'Viator',
...
export function getCityHubData(tenantId: string): CityHubData {
  ...
  return {
    ...data,
    news: [...liveNews, ...data.news].slice(0, 8)
  };
}
